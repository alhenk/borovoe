...
function getNewValues() {
    ...
    if(xmlHttp.readyState==4 || xmlHttp.readyState==0) {
        ...
        xmlHttp.open("POST", '../energ_param/handler_energ_param.php', true);
...
function handleResponse() {
 ...
 // obtain timestamp  
  ...
  valueArray = xmlRoot.getElementsByTagName("value");
            ...
            var W51_ad=document.getElementById("W51_ad");       // line 55
            W51_ad.innerHTML=valueArray.item(0).firstChild.data;

            var Qo=document.getElementById("Qo");       // line 56
            Qo.innerHTML=valueArray.item(1).firstChild.data;

            var Tamb=document.getElementById("Tamb");   // line 58
            Tamb.innerHTML=valueArray.item(2).firstChild.data;
        }
        else
